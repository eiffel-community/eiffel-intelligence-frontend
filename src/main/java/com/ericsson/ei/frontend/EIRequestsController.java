...
public class EIRequestsController {
     ...
     */
    @CrossOrigin
    @RequestMapping(value = { "/subscriptions", "/subscriptions/*", "/information", "/templates/*",
            "/auth", "/auth/*", "/queryAggregatedObject", "/queryMissedNotifications", "/query",
            "/rules", "/status", "/rules/rule-check/testRulePageEnabled" }, method = RequestMethod.GET)
