...
Feature: Query test
  ...
  Scenario: Query aggregated object by ID
    Given frontend is up and running
    And an aggregated object exists
    ...
    And request is sent
    Then response code 200 is received
    And response body from file 'queryIdAggregation.json' is received
  ...
  Scenario: Query aggregated object with freestyle criteria
    ...
    And request is sent
    Then response code 200 is received
    And response body from file 'queryFreestyleAggregation.json' is received