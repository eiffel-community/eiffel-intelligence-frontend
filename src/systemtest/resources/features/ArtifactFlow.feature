...
Feature: Artifact system test
  ...
  Scenario: Creates jenkins jobs, subscriptions and at last see that the flowcompletejob has been 
    ...
    Given subscription object "TCTSubscription" is created which will trigger "TCTJob" with parameters
    ...
    Given subscription object "TCSTCFSubscription" is created which will trigger "TCSTCFJob" with parameters
